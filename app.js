...
const DIRECTORIO_BOTS_MAESTRO = [
    {
        id: "b_cleopatra_ai",
        username: "CleopatraAIBot",
        titulo: "Cleopatra AI",
        logo: "https://res.cloudinary.com/dq7omdvi0/image/upload/f_auto,q_auto/IMG_20260617_141743_082_qzy4gg",
        descripcion_corta: "Generación multimodal de Texto & Imágenes por Inteligencia Artificial.",
        descripcion_larga: "El mejor bot de generación de texto y imágenes pot IA gratis con los ultimos modelos del mercado, Flux. Consultas de texto, creación de contenido, crea arte de texto a imagen o transforma tus fotos con la generación de imagen a imagen.",
        ...
        url_soporte: "https://t.me/Cleopatra_AI"
    },
    {
        id: "b_listagbot",
        username: "ListaG_Bot",
        titulo: "Lista G Bot",
        logo: "https://res.cloudinary.com/dq7omdvi0/image/upload/f_auto,q_auto/IMG_20260617_141734_683_ojlgxe",
        descripcion_corta: "Botonera de promoción para canales en Telegram, ¡haz crecer tu comunidad!.",
        descripcion_larga: "Ésta botonera permite agregar un canal a la promoción de publicidad gratis con apoyo mutuo entre creadores de contenido. Publicación automática, categorías, estadisticas y mucho más.",
        ...
        url_soporte: "https://t.me/ListaGolden"
    },
    {
        id: "b_bhbuttons",
        username: "BHButtons_bot",
        titulo: "BH Buttons",
        logo: "https://res.cloudinary.com/dq7omdvi0/image/upload/f_auto,q_auto/1000051745_vtwhhq",
        descripcion_corta: "Crea post con botones interactivos y gestiona tus canales gratis.",
        descripcion_larga: "Éste bot te permite crear y programar post con botones interactivos en tus canales de Telegram.",
        categorias: ["Herramientas", "Entretenimiento"],
        idioma: "Multi-idioma (EN/ES/IT/BR)",
        rating: 4.4,
         // --- CONTROL CRONOLÓGICO INDIVIDUAL ---
    ...
    },
    {
        ...
        logo: "https://res.cloudinary.com/dq7omdvi0/image/upload/f_auto,q_auto/1000051746_vlkgl1",
    ...
    {
        id: "b_botoneralistagolden",
        username: "BotoneraListaGolden_Bot",
        titulo: "Botonera Lista Golden",
        logo: "https://res.cloudinary.com/dq7omdvi0/image/upload/f_auto,q_auto/IMG_20260617_141752_451_ilxcin",
        descripcion_corta: "Botonera de promoción de @ListaGolden para canales de Telegram.",
        descripcion_larga: "Ésta botonera permite agregar un canal a la promoción de publicidad gratis con apoyo mutuo entre creadores de contenido. Publicación automática, categorías, estadisticas y mucho más.",
        categorias: ["Herramientas", "Entretenimiento"],
        idioma: "Multi-idioma (EN/ES/IT/BR)",
        rating: 4.5,
    ...
    },
    {
        ...
        descripcion_corta: "Monetiza tu canal con anuncios, crea, publica y automatiza post con IA.",
...
function toggleAcordeonTarjetaUnica(domId) {
    ...
    // Colores nativos en hexadecimal/estándar por si acaso
    const botNombre = `<span style="color: #f59e0b; font-weight: 800;">${botAleatorio.titulo}</span>`;

    let mensajeFinal = "";

    if (plantilla === "individual-fav") {
        mensajeFinal = `<strong style="color: #38bdf8; font-weight: 800;">${n}</strong> de ${b} añadió el bot ${botNombre} a sus favoritos.`;
    } else if (plantilla === "colectivo-fav") {
        mensajeFinal = `🔥 <strong style="color: #f43f5e; font-weight: 800;">${numUsuarios} personas</strong> agregaron el bot ${botNombre} a favoritos esta semana.`;
    } else if (plantilla === "colectivo-click") {
        mensajeFinal = `✨ <strong style="color: #10b981; font-weight: 800;">${numUsuarios} usuarios</strong> descubrieron el bot ${botNombre} hoy.`;
    ...
    // 🚀 ANIMACIÓN CON CSS NATIVO (Adiós clases de Tailwind)
    // Hace aparecer el cartel subiendo suavemente
    banner.style.opacity = "1";
    banner.style.transform = "translateY(0px)";
    
    // Ocultar a los 5 segundos (vuelve a bajar y se desvanece)
    setTimeout(() => { 
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    setTimeout(() => {
        if (typeof initFomoActividad === "function") {
            initFomoActividad();
            console.log("🔥 Sistema FOMO iniciado en segundo plano.");
        }
    }, 2000);
});
